...
var todoList = [new Note("Kom ihåg att köpa mjölk", true), new Note("Glöm inte tandkräm!", true), new Note("Bli klar med tentan innan torsdag nästa vecka!", true)];
...
function addNote() {
  try {
    var newNote;
    newNote = document.getElementById("newNoteInput").value;
    ;
